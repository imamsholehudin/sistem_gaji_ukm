                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title"><b>Ubah Data Karyawan</b></h3>
                                    <br><br>
                                ...
                                <!-- form start -->
                                <form action="karyawan-ubah-proses.php" method="POST">
                                    <?php
                                    ...
                                    <div class="card-body">
                                        <input type="hidden" class="form-control" name="id" id="exampleInputPassword1"
                                            placeholder="Enter NIK" value="<?php echo $data['id']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama"
                                                ...
                                                value="<?php echo $data['nama_karyawan']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Telp</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="pendidikan"
                                                ...
                                                value="<?php echo $data['pendidikan_terakhir']; ?>" required>
                                        </div>
